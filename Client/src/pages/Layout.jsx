        ...
        <ul className="nav flex-column text-white w-100">
          ...
          <li>
            ...
            <Link to="/addContact" className="nav-link">
              <span className="mx-1">Add New Contact</span>
            </Link>
            {/* <Link to="/Request_Users" className="nav-link">
              <span className="mx-1">Request Users</span>
            </Link>
            <Link to="/Marrage_certU" className="nav-link">
              <span className="mx-1">Marriage Certificate</span>
            </Link> */}
            <Link to="/CityHome" className="nav-link">
              <span className="mx-1">Approval list</span>
            </Link>
            <Link to="/City_Birth_Certi" className="nav-link">
              <span className="mx-1">Birth Certificate list</span>
            </Link>
            <Link to="/City_Marrage_Certi" className="nav-link">
              <span className="mx-1">Marrage Certificate</span>
            </Link>
          </li>
        </ul>
      </div>
